...
NFL_plot$Position = factor(NFL_plot$Position, labels = c("Offense", "Defense", "Special Teams"), levels = c("OFFENSE", "DEFENSE", "SPECIAL_TEAMS"))
NFL_plot <- NFL_plot |>
  ggplot(aes(x = Year, y = `Average Salary`, col = Position)) + 
